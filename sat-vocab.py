...
def looplist(dicti):
    ...
    while True:
        ...
        print(f'''
        {lst[i][0]}
        {len(dicti)-len(lst)} / {len(dicti)}
        ''')
        input("continue: ")
        print(f'''
            {lst[i][0]}
            {lst[i][1]}
            {len(dicti) - len(lst)} / {len(lst)}
            ''')
        yn = input("known or not: ")
        if yn in ["y", "yes", "yeah", "known", ""] and z == 0:
            lst.remove(lst[i])
            z = 0
        elif z == 1:
            z = 0
...
level31 = {
    ...
    'Peccadillo': 'minor weakness; trivial offense',
    ...
    'Forensic': 'concerned with argument or debate (especially for legal evidence)',
...
level50 = {
    'ab': 'away from, abduct, abhor, abnormal',
    'acer': 'sour, acidity, acidulous, acerbic',
    'acro': 'high, acrobat, acrophobia, acromegaly',
    'acu': 'sharp, acute, acupuncture, acuity',
    'aer': 'air, aerodynamics, aeronautics, aerobic',
    'agri': 'field, agriculture, agribusiness, agronomy',
    'alb': 'white, albino, albumen, albinism',
    'amb': 'both, ambidextrous, ambivalent, ambiguous',
    'ambul': 'walk, ambulance, amble, ambulatory',
    'amic': 'friend, amicable, amity, amicability',
    'anim': 'life, animate, animal, inanimate',
    'ann': 'year, annual, bicentennial, anniversary',
    'ante': 'before, antebellum, antecedent, antedate',
    'anthro': 'human, anthropology, philanthropy, misanthrope',
    'anti': 'against, antibiotic, antipathy, antagonist',
    'aqu': 'water, aquarium, aqueduct, aquifer',
    'arbor': 'tree, arborist, arboriculture, arborescent',
    'arche': 'beginning, archaeology, archetype, archeozoic',
    'arthr': 'joint, arthritis, arthropod, arthroscopy',
    'astro': 'star, astronomy, astrologer, astronaut'}
level51 = {
    'audi': 'hear, audio, audition, auditorium',
    'auto': 'self, autobiography, automatic, autocracy',
    'avi': 'bird, aviary, aviation, avian',
    'bel': 'war, belligerent, rebel, bellicose',
    'bene': 'good, benefit, benevolent, benign',
    'bi': 'two, bilingual, bisexual, bifocal',
    'biblio': 'book, bibliography, bibliophile, bible',
    'bio': 'life, biology, biosphere, biopsy',
    'blast': 'bud, blastocyst, blastula, blastoderm',
    'bon': 'good, bonus, bonanza, bonhomie',
    'cap': 'take, capture, capability, capacious',
    'capt': 'seize, captive, intercept, captor',
    'cardi': 'heart, cardiac, cardiologist, cardiovascular',
    'cata': 'down, catastrophe, catalog, catapult',
    'caust': 'burn, caustic, cautery, holocaust',
    'ceive': 'take, receive, perceive, conceive',
    'cent': 'hundred, century, centipede, centennial',
    'cede': 'go, concede, proceed, recede',
    'cerebr': 'brain, cerebral, cerebrate, cerebrovascular',
    'cert': 'sure, certain, certify, certificate'
}
level52 = {
    ...
    'clam': 'call out, proclaim, clamor, exclamation',
    'clar': 'clear, clarify, clarity, declaration',
    'clud': 'shut, exclude, include, preclude',
    'clin': 'lean, incline, decline, recline',
    'co': 'together, cooperate, coordinate, coexist',
    'cog': 'know, cognitive, recognize, incognito',
    'con': 'with, together, connect, congregate, consensus',
    'contra': 'against, contrary, contradict, controversy',
    'corp': 'body, corporation, corpse, corporal',
    'cosm': 'universe, cosmos, cosmopolitan, microcosm',
    'counter': 'opposite, counteract, counterbalance, counterpoint',
    'cracy': 'rule, government, democracy, aristocracy',
    'cred': 'believe, credible, credit, credence',
    'crypt': 'hidden, cryptic, encrypt, cryptography',
    'culp': 'blame, culpable, culprit, exculpate',
    'cumul': 'heap, accumulate, cumulative, cumulus',
    'cycle': 'circle, bicycle, recycle, cyclical'}
level53 = {
    'dec': 'ten, decade, decimal, decathlon',
    'dem': 'people, democracy, demographic, epidemic',
    'dent': 'tooth, dental, dentistry, dentist',
    'derma': 'skin, dermatology, epidermis, hypodermic',
    'di': 'two, diameter, divide, digraph',
    'dia': 'across, diagonal, dialogue, diameter',
    'dic': 'speak, dictate, predict, diction',
    'domin': 'rule, dominant, domain, predominate',
    'don': 'give, donate, pardon, condone',
    'dorm': 'sleep, dormant, dormitory, dormancy',
    'dur': 'hard, durable, endure, duration',
    'dyn': 'power, dynamic, dynasty, hydrodynamics',
    'ego': 'self, egotist, egoism, alter ego',
    'ence': 'quality, presence, competence, excellence',
    'endo': 'within, endocrine, endoskeleton, endogenous',
    'esth': 'feeling, aesthetic, anesthetic, kinesthetic',
    'ethn': 'race, ethnicity, ethnocentrism, ethnography',
    'eu': 'good, euphoria, eulogy, eugenics',
    'ex': 'out, exit, external, exotic',
    'extra': 'beyond, extraordinary, extracurricular, extraterrestrial'}
level54 = {
    'fac': 'make, manufacture, factory, facilitate',
    'famil': 'close attendant, familiar, familial, familiarity',
    'femin': 'woman, feminine, feminism, effeminate',
    'fend': 'defend, offense, fence, defendable',
    'fer': 'carry, transfer, infer, refer',
    'fid': 'faith, confidence, fidelity, infidel',
    'flect': 'bend, deflect, flexible, inflection',
    'foli': 'leaf, foliage, portfolio, defoliate',
    'fore': 'before, forecast, foresight, foreboding',
    'fract': 'break, fracture, fragment, refract',
    'fug': 'flee, fugitive, refuge, fugue',
    'fum': 'smoke, fume, perfumed, fumigate',
    'fusc': 'dark, obscure, fuscous, effusive',
    'gen': 'birth, origin, generate, genealogy',
    'geo': 'earth, geography, geology, geocentric',
    'ger': 'old, geriatric, germinate, germicide',
    'giga': 'billion, gigabyte, gigawatt, gigahertz',
    'gon': 'angle, polygon, octagon, pentagon',
    'grad': 'step, degree, graduate, gradual',
    'gram': 'letter, grammar, telegram, monogram'
}
level55 = {
    'graph': 'write, draw, autograph, photograph',
    'grat': 'pleasing, grateful, gratify, gratitude',
    'grav': 'heavy, serious, gravity, aggravate',
    'gymn': 'naked, gymnastics, gymnasium, gymnopédie',
    'gyn': 'woman, gynecology, androgynous, misogyny',
    'hab': 'have, habitat, habit, inhabit',
    'helio': 'sun, heliotrope, heliocentric, heliograph',
    'hemo': 'blood, hemoglobin, hemorrhage, hematoma',
    'hepa': 'liver, hepatitis, hepatomegaly, hepatocyte',
    'herbi': 'plant, herbicide, herbivore, herbal',
    'hex': 'six, hexagon, hexameter, hexapod',
    'hiero': 'sacred, hieroglyphics, hierarchy, hieratic',
    'histo': 'tissue, histology, histamine, histopathology',
    'homo': 'same, homo sapiens, homonym, homogeneous',
    'hosp': 'host, hospital, hospitality, hospice',
    'host': 'enemy, hostile, host, hostage',
    'hydra': 'water, hydrant, hydrometer, hydraulics',
    'hyper': 'over, hyperactive, hypersensitive, hypertension',
    'hypno': 'sleep, hypnosis, hypnotherapy, hypnotic',
    'hypo': 'under, hypodermic, hypothermia, hypothyroidism'}
leve56 = {
    'ian': 'person, musician, historian, electrician',
    'iatr': 'medical treatment, pediatrics, geriatrics, psychiatry',
    'icon': 'image, iconography, iconic, iconoclast',
    'ideo': 'idea, ideology, ideogram, ideologue',
    'idio': 'peculiar, idiosyncrasy, idiopathic, idiom',
    'in': 'not, opposite, invisible, incorrect',
    "infra": "below, infra-red, infrastructure, infrared",
    "init": "beginning, initiate, initial, initiation",
    "inter": "between, international, internet, intercept",
    "ir": "not, irregular, irrational, irresponsible",
    "iso": "equal, identical, isometric, isotope",
    "ject": "throw, inject, reject, project",
    "jud": "judge, judgment, judicial, prejudice",
    "junct": "join, junction, conjunction, disjunction",
    "juven": "young, juvenile, rejuvenate, juvenilia",
    "kilo": "thousand, kilometer, kilogram, kilowatt",
    "kine": "motion, kinetic, telekinesis, kinesiology",
    "lab": "work, laboratory, labor, collaborate",
    "lat": "wide, lateral, latitude, dilate",
    "later": "side, lateral, bilateral, collateral"}
level57 = {
    "laud": "praise, laudable, applaud, laudatory",
    "lax": "loose, relax, laxative, laxity",
    "less": "without, endless, hopeless, thoughtless",
    "lev": "light, levitate, alleviate, relevant",
    "lex": "word, lexicon, lexical, alexia",
    "liber": "free, liberty, liberal, liberate",
    "lingu": "language, linguistics, bilingual, linguist",
    "lipo": "fat, liposuction, liposome, lipoprotein",
    "lith": "stone, lithography, monolith, megalith",
    "liter": "letter, literature, illiterate, alliteration",
    "loc": "place, location, local, relocate",
    "locu": "speak, eloquent, loquacious, soliloquy",
    "log": "reason, logic, logarithm, dialogue",
    "longus": "long, longitude, longevous, oblong",
    "luc": "light, lucid, elucidate, translucent",
    "lud": "play, ludicrous, illusion, allude",
    "lumin": "light, illuminate, luminous, bioluminescence",
    "macro": "large, macroeconomics, macroscopic, macrocosm",
    "maj": "greater, major, majority, majestic",
    "mal": "bad, malevolent, malfunction, malnutrition"}
level58 = {
    "man": "hand, manual, manufacture, manipulate",
    "mand": "order, command, demand, mandatory",
    "mania": "madness, mania, kleptomania, megalomania",
    "mar": "sea, marine, marina, submarine",
    "mater": "mother, maternal, maternity, alma mater",
    "max": "greatest, maximum, maxillary, maximize",
    "medi": "middle, median, medium, immediate",
    "mega": "great, megaphone, megalomania, megabyte",
    "melan": "black, melanin, melancholy, melanoma",
    "memor": "remember, memory, memorial, memorandum",
    "merge": "to combine or blend into a single entity or group, merge, emerge, submerge",
    "meso": "middle, intermediate, mesosphere, mesomorphic",
    "meta": "beyond, change, transformation, metaphysics, metamorphosis",
    "meter": "measure, measurement, perimeter, kilometer",
    "micro": "small, minute, microscopic, microbiology",
    "mid": "middle, midway, midday, midnight",
    "migr": "move, migration, emigrate, immigrate",
    "milli": "thousandth, millimeter, millisecond",
    "min": "small, less, minimize, minimum",
    "mir": "wonder, admiration, admire, miracle"}
level59 = {
    "mis": "wrong, bad, mistaken, mislead",
    "miss": "send, let go, dismiss, missile",
    "mob": "move, motion, mobile, mobilize",
    "mon": "one, single, alone, monochrome, monotheism",
    "mort": "death, mortal, mortician, mortuary",
    "mot": "move, motion, motor, motivate",
    "multi": "many, much, multiple, multiply",
    "mut": "change, alteration, mutation, mutant",
    "my": "muscle, muscle tissue, myocardium",
    "narr": "to tell, recount, narrative, narrator",
    "nat": "born, birth, nature, innate",
    "naut": "sailor, ship, nautical, astronaut",
    "neg": "no, deny, negate, negative",
    "neur": "nerve, nervous system, neurology",
    "neo": "new, recent, neoclassical, neologism",
    "nomin": "name, nominate, nomination",
    "non": "not, without, nonexistent, nonfiction",
    "not": "mark of negation, not, note, notify",
    "noun": "name, noun, pronounce, noun phrase",
    "nov": "new, original, novelty, innovate"}
level60 = {
    "null": "nothing, zero, nullify, null hypothesis",
    "numer": "number, numeral, enumerate, numerous",
    "ob": "against, in the way, obstruct, obstacle",
    "oct": "eight, octave, octagon",
    "ocu": "eye, sight, ocular, binoculars",
    "omni": "all, every, omnivorous, omnipotent",
    "ono": "name, word, anonymous, onomatopoeia",
    "opt": "see, vision, optical, optometrist",
    "ortho": "straight, correct, orthodontist, orthopedics",
    "osteo": "bone, skeleton, osteoporosis, osteopathy",
    "ous": "having, full of, joyous, dangerous",
    "out": "beyond, surpassing, outdoor, outwit",
    "over": "above, beyond, excessive, overestimate",
    "oxy": "sharp, pointed, oxygen, oxymoron",
    "paleo": "old, ancient; Paleolithic, paleography",
    "pan": "all, every; panacea, pantheon",
    "para": "beside, beyond; paranormal, paramedic",
    "path": "feeling, suffering; empathy, pathology",
    "pel (puls)": "drive, push; compel, repel",
    "ped": "foot; pedestrian, pedal"}
level61 = {
    "penta": "five; pentagon, pentameter",
    "per": "through, thoroughly; permeate, perfect",
    "peri": "around, about; perimeter, periscope",
    "phag": "eat; phagocyte, bacteriophage",
    "phil": "love; philosophy, philanthropy",
    "phob": "fear; arachnophobia, claustrophobia",
    "phon": "sound, voice; telephone, phonetics",
    "photo": "light; photograph, photosynthesis",
    "phyt": "plant; phytology, neophyte",
    "pneu": "breath, air; pneumonia, pneumatic",
    "poli (polis)": "city; politics, megalopolis",
    "pop": "people; population, popular",
    "port": "carry; transport, portable",
    "pos": "place, put; position, deposit",
    "post": "after; postgraduate, postmortem",
    "pre": "before; prehistoric, premonition",
    "pseudo": "false; pseudonym, pseudoscience",
    "psyche": "mind, soul; psychology, psychedelic",
    "pugn (pung)": "fight; pugnacious, repugnant",
    "pul": "push; expel, repulse"}
level62 = {
    "purg": "cleanse; purgatory, purgative",
    "pyr": "fire; pyromania, pyrotechnics",
    "quad": "four; quadrilateral, quadruped",
    "quin": "five; quintet, quinquennial",
    "radic (radix)": "root; radical, eradicate",
    "re": "back, again; repeat, return",
    "reg": "rule; regulate, regal",
    "retro": "backward; retroactive, retrograde",
    "rhod": "rose; rhododendron, rhodolite",
    "rid": "laugh; ridiculous, deride",
    "rub": "red; ruby, rubella",
    "rupt": "break; erupt, rupture",
    "san": "health; sanitary, sanitation",
    "scend": "climb; ascend, transcend",
    "sci": "know; science, conscious",
    "scop": "see; microscope, periscope",
    "scrib": "write; scribe, describe",
    "se": "apart, away; separate, secede",
    "sect": "cut, separate, divide; sect, section, dissect",
    "sed": "sit, settle, calm; sedate, sedentary, sediment"}
level63 = {
    "self": "self, same; self-esteem, self-respect, selfish",
    "semi": "half, partly; semicircle, semifinal, semiconscious",
    "sens": "feel, sense; sensitive, sensation, sensory",
    "serv": "save, keep, serve; service, servant, preserve",
    "sol": "alone, only; solitary, solo, solipsism",
    "son": "sound; sonar, sonic, resonate",
    "soph": "wisdom, knowledge; philosopher, sophisticated, sophomore",
    "spect": "see, look; inspect, spectator, perspective",
    "sphere": "ball, globe; atmosphere, hemisphere, stratosphere",
    "spir": "breathe, spirit; inspire, expire, perspire",
    "sta": "stand; stable, station, state",
    "stell": "star; constellation, stellar, interstellar",
    "sub": "under, below; submarine, submerge, subpar",
    "super": "above, beyond; supernatural, superhuman, superfluous",
    "syn": "together, with; synchronize, synergy, synthesis",
    "tact": "touch; tactile, contact, intact",
    "tax": "arrange, order; taxonomy, syntax, parataxis",
    "techn": "skill, art, craft; technique, technological, technocrat",
    "tele": "far, distant; telephone, telepathy, telescope",
    "temp": "time; temporary, contemporary, extemporaneous"}
level64 = {
    "term": "end, boundary; terminate, terminal, interminable",
    "tetra": "four; tetrahedron, tetrameter, tetracycline",
    "theo": "god, religion; theology, theocracy, atheism",
    "tort": "twist; torture, distort, contortion",
    "tox": "poison; toxic, intoxicate, antitoxin",
    "tract": "pull, draw; tractor, attract, extract",
    "trans": "across, beyond; transport, transmit, transcontinental",
    "ultra": "beyond, extreme; ultraviolet, ultramodern, ultraconservative",
    "un": "not; unhappy, uncertain, unthinkable",
    "uni": "one; unity, universe, unicycle",
    "urb": "city; urban, suburban, urbane",
    "vac": "empty; vacuum, evacuate, vacant",
    "ven": "come; convene, intervene, adventure",
    "vic": "conquer; victory, vicar, convince",
    "vid": "see; video, evidence, provide",
    "voc": "voice, call; vocal, vociferous, invocation",
    "vor": "eat, devour; carnivorous, herbivore, omnivore",
    "xen": "stranger, foreigner; xenophobia, xenophile, xenogenesis",
    "zoo": "animal; zoology, zookeeper, zooplankton"}
